...
module QuantinuumBackend =
    ...
    let mapQuantinuumError (errorCode: string) (errorMessage: string) : QuantumError =
        ...
        | _ ->
            ...
            QuantumError.UnknownError(0, sprintf "Quantinuum error: %s - %s" errorCode errorMessage)
                        ...
                        | Some uri ->
                            ...
                            | Ok jobResult ->
                                ...
                                try
                                    ...
                                    return Ok histogram
                                with
                                | ex -> return Error (QuantumError.UnknownError(0, sprintf "Failed to parse Quantinuum results: %s" ex.Message))
