...
module TopologicalFormat =
    ...
    module Parser =
        ...
        let parseProgram (text: string) : ParseResult<Program> =
            ...
            | Some anyonLine ->
                let parts =
                    anyonLine.Trim().Split([| ' '; '\t' |], StringSplitOptions.RemoveEmptyEntries)
    ...
    module Serializer =
        ...
        let serializeProgram (program: Program) : string =
            ...
            let operationLines = program.Operations |> List.map serializeOperation
    ...
    module Executor =
        ...
        let executeProgram (backend: IQuantumBackend) (program: Program) : Result<ExecutionResult, QuantumError> =
        ...
        let executeFile (backend: IQuantumBackend) (filePath: string) : Result<ExecutionResult, QuantumError> =
