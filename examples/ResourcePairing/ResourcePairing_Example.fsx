...
Cli.exitIfHelp
    "ResourcePairing_Example.fsx"
    "Quantum optimal pairing / matching"
    [
        {
            Name = "example"
            Description = "Which example: all, mentors, teams, interviews"
            Default = Some "all"
        }
        {
            Name = "shots"
...
let displayResult (label: string) (result: Result<ResourcePairing.PairingResult, QuantumError>) =
    ...
    | Ok r ->
        ...
        pr
            "  Paired:       %d / %d participants%s"
            r.ParticipantsPaired
            r.TotalParticipants
