    ...
    [
        {
            ...
            Description = "CSV file with custom metabolic pathways"
            Default = Some "built-in presets"
        }
        {
            Cli.OptionSpec.Name = "pathways"
    ...
    let reactant: Molecule =
        {
            ...
            Atoms =
                [
                    ...
                    {
                        Element = "H"
                        Position = (1.09, 0.0, 0.0)
                    }
                    {
                        Element = "H"
                        Position = (-0.547, 0.944, 0.0)
                    }
                ]
            Bonds =
                [
    ...
    let ts: Molecule =
        {
            ...
            Atoms =
                [
                    ...
                    } // stretched C-H (1.09 -> 1.35)
                    {
                        Element = "O"
                        Position = (2.65, 0.0, 0.0)
                    } // O approaching
                    {
                        Element = "H"
                        Position = (3.3, 0.7, 0.0)
                    }
                ] // O-H
            Bonds =
                [
    ...
    let reactant: Molecule =
        {
            ...
            Atoms =
                [
                    ...
                    {
                        Element = "H"
                        Position = (-0.54, 0.94, 0.0)
                    }
                    {
                        Element = "H"
                        Position = (-0.54, -0.47, 0.82)
                    }
                    {
                        Element = "H"
                        Position = (1.86, 0.46, 0.82)
                    }
                ]
            Bonds =
                [
    ...
    let ts: Molecule =
        {
            ...
            Atoms =
                [
                    ...
                    {
                        Element = "O"
                        Position = (-1.30, 0.0, -0.80)
                    } // O approaching C
                    {
                        Element = "H"
                        Position = (-1.85, 0.0, -0.10)
                    }
                ] // transferred H
            Bonds =
                [
    ...
    let ts: Molecule =
        {
            ...
            Atoms =
                [
                    ...
                    {
                        Element = "C"
                        Position = (1.40, 0.0, 0.0)
                    } // stretched C=C
                    {
                        Element = "O"
                        Position = (0.70, 0.0, 1.60)
                    } // O approaching from above
                    {
                        Element = "H"
                        Position = (-0.54, 0.94, 0.0)
                    }
...
let private builtinPresets: Map<string, MetabolicPathway> =
    [
        ...
        nDealkylationPathway
        aromaticOxidationPathway
        sulfoxidationPathway
    ]
...
let printTable () =
    ...
    printfn "  %-4s  %-22s  %-8s  %13s  %11s  %s" "#" "Pathway" "Enzyme" "dE (kcal/mol)" "Time (s)" "Thermodynamics"
    printfn "  %s" (String('-', 85))
...
if not quiet then
    ...
    printfn
        "  Best pathway:  %s via %s (Ea = %.2f kcal/mol)"
        best.Pathway.Name
        best.Pathway.Enzyme
        best.ActivationEnergyKcal
